...
const Footer = () => {
    return (
      <div className="max-w-screen-xl px-4 mx-auto mt-20">
        <div className="grid md:grid-cols-3 gap-10">
          <div className="">
            ...
            <p className="mt-5 text-justify">
              We focus on individual needs, interests and abilities with a view
              to implement student centric approach. At our center, all children
